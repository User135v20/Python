Программа переводит из 10-чной системы в другую, для этого сначала вводится число, потом система счисления(вводятся все элементы системы счисления по возрастанию)
